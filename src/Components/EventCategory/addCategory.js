...
import { creatEventCategory, updateEventCategory } from "../../APIS/apis";
  ...
  doSubmit = async () => {
    ...
    try {
      ...
      if (this.state.isEditing) {
        await updateEventCategory(reqData, this.state.id);
      } else {
        await creatEventCategory(reqData);
      }
      alert(
      ...
      this.props.navigate("/eventCategories");
